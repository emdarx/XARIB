...
game_waiting = (function () {
    return function (str) {
        ...
        __init50Hss__();
        var resultUpTo1_80 = getAlgorithmNumberHash(str.md5, 1.05, 1.80);
        var resultUpTo5_00 = getAlgorithmNumberHash(str.md5, 6.20);
        
        // Calculate the average of the two results
        var averageCashout = (parseFloat(resultUpTo1_80) + parseFloat(resultUpTo5_00)) / 2;
        
        // Add 5% randomness
        var randomPercentage = (Math.random() - 0.5) * 0.1; // Between -5% and 5%
...
function getCalculatedNum(arr, num) {
    ...
    var maxCashout = 6.20; // Change to desired value
